...
$(function() {
    $(window).scroll(function() {
        ...
        if (mediaQuery.matches) {
            footer_btm = $(document).scrollTop() + $(window).height() + 900;
        }
        if (mediaQuery3.matches) {
            footer_btm = $(document).scrollTop() + $(window).height() + 600;
        }
        ...
        var timer_btm = $(document).scrollTop() + $(window).height() + 800;
        var timer_btm2 = $(document).scrollTop() + $(window).height() + 550;
        if (mediaQuery2.matches) {
            timer_btm = $(document).scrollTop() + $(window).height() + 900;

            timer_btm2 = $(document).scrollTop() + $(window).height() + 300;
        }
        ...
        if (timer_btm2 < $(document).height()) {

            document.querySelector(".timer-section").style.transition = "0.2s cubic-bezier(0.645, 0.045, 0.355, 1)";
            document.querySelector(".timer-section").style.marginTop = "-40vh";
            document.querySelector(".timer-section").style.opacity = 1;
            document.querySelector(".timer-section").style.paddingTop = "0vh";
